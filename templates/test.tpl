...
<style>
    @font-face {
        ...
        src: url('../static/fonts/exports/{{ project }}.ttf');
    }
    /* .page{ */
    /* 	display: flex; */
    /* }  */
    ...
    <div id="pages">
        ...
        <div id="specimenOptions">
            ...
            <div class="button-grid">
                <div id="btn_print" class="btn">print</div>
                <a href="../static/fonts/exports/{{ project }}.ttf" class="btn download-it">download {{ project }}</a>
            </div>
        </div>
